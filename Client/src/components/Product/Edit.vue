...
export default {
  ...
  methods: {
    ...
    getAddressStatus: function() {
      ...
      this.axios
        .get(this.$gc.getBaseUrl("profiles/address/status"))
        .then(function(data) {
    ...
    update: function() {
      ...
      if (!this.$v.invalid) {
        this.axios.defaults.headers.common["Authorization"] = this.$auth.FAH();
        this.axios
          .put(this.$gc.getBaseUrl("products"), {
            product_id: this.id,
            name: this.name,
            price: this.price,
    ...
    removeImage: function(e) {
      ...
      this.axios
        .delete(
          this.$gc.getBaseUrl(
            "resources/products/images/" + this.id + "/" + e.name
          ),
          {}
        )
        .then(function(data) {})
  ...
  beforeMount: function() {
    ...
    this.axios
      ...
      .then(function(data) {
        ...
        var baseImagePath = those.$gc.getBaseUrl(
          "resources/images/" + data.data.product.id + "/"
        );
